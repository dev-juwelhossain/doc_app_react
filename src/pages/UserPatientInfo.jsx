...
import { faArrowRight, faBarsStaggered, faBell, faClock, faFilePdf, faHospitalUser, faHouseMedical, faSearch, } from '@fortawesome/free-solid-svg-icons';
        ...
        <div>
            <div class="sh-mobile-navbar">
                <ul>
                    ...
                    <li><NavLink to="/user-patient-info" style={({ isActive }) => ({ color: isActive ? "white" : "black", backgroundColor: isActive ? "#0065c0" : "transparent", })}> <FontAwesomeIcon icon={faHospitalUser} /></NavLink></li>
                ...
                <div class="sh-left-side-menu-container sh-close">
                    ...
                    <div class="sh-left-side-menu-items">
                        <ul>
                            ...
                            <li><NavLink to="/user-patient-info" style={({ isActive }) => ({ color: isActive ? "white" : "black", backgroundColor: isActive ? "#0065c0" : "transparent", })}> <FontAwesomeIcon icon={faHospitalUser} />রোগীর তথ্য</NavLink></li>
