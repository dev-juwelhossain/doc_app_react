...
import '../auth_css/doc-signup.css'
const DocSignUp = () => {
    return (
        <div className='doc-signup-header'>
            <div class="sh-doctor-sign-up-container">
                <div class="sh-doc-account-text">
                    <p>অ্যাকাউন্ট তৈরি করুন</p>
                </div>
                <div class="sh-doc-sign-up-box">
                    <div class="sh-doc-sign-up-details">
                ...
                {/*  <!-- === SIGN UP BUTTON === --> */}
                <div class="sh-sign-up-btn">
                    <button>সাইন আপ করুন</button>
                </div>
                <div onclick="haveAccount()" class="sh-already-account">
                    <button>
                        <NavLink to="/doc-login">আমার একটি অ্যাকাউন্ট আছে</NavLink>
                    </button>
                </div>
            </div>
        </div >
